...
export const validateUpdateIncident = (req: Request, res: Response, next: NextFunction) => {
...
export const validateIncidentId = (req: Request, res: Response, next: NextFunction) => {
